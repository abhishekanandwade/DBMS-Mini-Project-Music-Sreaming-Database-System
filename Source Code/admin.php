...
$search = mysqli_query($conn,"SELECT user, pass   FROM admin WHERE user='$User' AND pass='$Pass'") or die(mysqli_error());
...
<html lang="en">
  <head>
    ...
    background: url(Admin1.jpg)no-repeat
    center center fixed;
...
<div class="button1">
    ...
    <a href= "index.php"><button type="submit" class ="button1"><span>User</span></button></a>
